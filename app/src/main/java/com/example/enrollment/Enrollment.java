    ...
    private void submitSelectedSubjects() {
        ...
        enrollmentRef.set(new EnrollmentData(selectedSubjects, totalCredits))
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(Enrollment.this, "Error saving enrollment: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
        ...
        subjectsRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Enrollment.this, "Error getting subjects: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
            ...
            checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    ...
                    if (totalCredits + subject.getCredits() > MAX_CREDITS) {
                        Toast.makeText(Enrollment.this, "Cannot exceed " + MAX_CREDITS + " credits.", Toast.LENGTH_SHORT).show();
